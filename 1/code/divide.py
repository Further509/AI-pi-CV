...
Images_path = 'ImageSets'  # 源图路径
Labels_path = 'Label'  # 源标签路径

train_labels = 'labels/train'  # train标签路径
val_labels = 'labels/val'  # val标签路径

train_images = 'images/train'  # 保存train图像路径
val_images = 'images/val'  # 保存val图像路径

radio = 0.1  # 按照比例划分的验证集比例
nums = 100  # 按照数量划分的验证集数量
is_radio = True  # 如果为True，则按照比例进行划分，否则按照数量划分
